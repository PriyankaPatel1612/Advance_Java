...
public class TestHttpSession1 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Test Http Session1</title>");
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>Test Http Session1 </h1>");
        out.println("<form action=TestHttpSession2 method=post>");
        out.println("<table>");
        out.println("<tr>");
